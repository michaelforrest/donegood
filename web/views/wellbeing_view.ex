defmodule Donegood.WellbeingView do
  use Donegood.Web, :view

  def render("index.json", %{wellbeings: wellbeings}) do
    %{data: render_many(wellbeings, Donegood.WellbeingView, "wellbeing.json")}
  end

  def render("show.json", %{wellbeing: wellbeing}) do
    %{data: render_one(wellbeing, Donegood.WellbeingView, "wellbeing.json")}
  end
